...
async def test_vision_find_then_tap_flow() -> None:
    ...
    vision_result = await vision_find_element(screenshot_base64, "美团 app", vision_client=mock_vision)
...
async def test_vision_smart_navigation_flow() -> None:
    ...
    result1 = await vision_find_element(screenshot_b64, "快手 app", vision_client=mock_vision)
    ...
    result2 = await vision_find_element(screenshot_b64, "快手 app", vision_client=mock_vision)
...
async def test_vision_describe_then_interact_flow() -> None:
    ...
    describe_result = await vision_describe_screen(screenshot_b64, vision_client=mock_vision)
    ...
    find_result = await vision_find_element(screenshot_b64, "搜索框", vision_client=mock_vision)
