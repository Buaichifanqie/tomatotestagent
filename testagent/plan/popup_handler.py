...
DEFAULT_POPUP_RULES = [
    PopupRule(name="permission_dialog", target_text=["权限"], action="tap", button_text="允许"),
    PopupRule(name="update_dialog", target_text=["发现新版本", "立即更新"], action="tap", button_text="稍后"),
    PopupRule(name="privacy_agreement", target_text=["同意并继续"], action="tap", button_text="同意并继续"),
    PopupRule(name="ad_dialog", target_text=["广告", "推广"], action="dismiss", button_text="关闭"),
    PopupRule(name="teen_mode", target_text=["未成年人模式"], action="tap", button_text="不再提醒"),
