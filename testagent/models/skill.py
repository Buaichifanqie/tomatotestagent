...
class SkillDefinition(BaseModel):
    ...
    required_mcp_servers: Mapped[dict[str, object] | None] = mapped_column(JSONType, nullable=True)
    required_rag_collections: Mapped[dict[str, object] | None] = mapped_column(JSONType, nullable=True)
    body: Mapped[str | None] = mapped_column(Text, nullable=True)
    tags: Mapped[dict[str, object] | None] = mapped_column(JSONType, nullable=True)
